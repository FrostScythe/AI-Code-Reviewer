...
public class AIService {
    ...
    public String analyzeCode(String code) {
        ...
        if (apiKey == null || apiKey.isBlank()) {
            return "Error: Google API Key is missing. Please set the API_KEY environment variable.";
        }
        ...
        String promptText = "You are a senior software engineer. Analyze the following code:\n"
                ...
                + " - Suggest an optimised code version\n"
        ...
        try {
            ...
            if (response.getStatusCode() == HttpStatus.OK) {
                ...
                List<Map<String, String>> responseParts =
